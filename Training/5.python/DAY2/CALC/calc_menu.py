# File Name		: calc_menu.py	
# Functions		:	The Calculator Menu Program
#				-> simple calculator
...
while(1):
	...
	try:
		...
		print "NameError: Can't read data, Enter a valid integer"
	except SyntaxError:
		print "SyntaxError: Can't read !! Enter valid integer"
	else:
			if choice == 1:
				print "-".center(40,'-')
				print "1. ADD\n2. SUB\n3. MUL\n4. DIV\n5.GO BACK"
				try:
					...
					print "NameError: Enter a valid integer"
				except SyntaxError:
					print "SyntaxError: Enter a valid integer"
				else:
					print "-".center(40,'-')
